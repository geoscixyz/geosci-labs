...
def WaveVelandSkindWidgetTBL(epsr, sigma):
    ...
    ax[0].text(25*1e6,   11*1e8, ("%3.1f m/s")%(velsm1[0])  ,fontsize = 10) 
    ax[0].text(100*1e6,  11*1e8, ("%3.1f m/s")%(velsm1[1])  ,fontsize = 10) 
    ax[0].text(1000*1e6, 11*1e8, ("%3.1f m/s")%(velsm1[2])  ,fontsize = 10) 
