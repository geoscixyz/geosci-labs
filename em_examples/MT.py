...
def PlotAppRes3Layers_wrapper(log_fmin,log_fmax,nbdata,h1,h2,rhol1,rhol2,rhol3,mul1,mul2,mul3,epsl1,epsl2,epsl3,PlotEnvelope,F_Envelope):

    frangn=frange(log_fmin,log_fmax,nbdata)
...
def MT1D_app():
    app = interact(PlotAppRes3Layers_wrapper,
        log_fmin = FloatSlider(min=-5.,max=5., value = -5, continuous_update=False),
        log_fmax = FloatSlider(min=-5.,max=5., value = 5, continuous_update=False),
